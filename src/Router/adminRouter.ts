...
import { addJobsController, updateJobsController, viewJobsController, getUserController, deleteJobsController, filterApplicants,  } from '../Controller/adminController'
...
router.get('/filter-applications/:id',  passport.authenticate('jwt', { session: false }), authorization(admin),filterApplicants)
